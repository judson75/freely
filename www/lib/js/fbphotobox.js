(function($) {
	...
	FBPhotoBox.prototype = {
		...
		initDOM: function() {
			...
			html += '<a title="Full Screen" class="fbphotobox-fc-btn fbphotobox-a" style="background-image: url(/lib/images/fullscreen.png);';
			...
			html += '<a class="fbphotobox-a" title="Previous" style="background-image: url(/lib/images/Arrows-LWhite-icon.png);';
			...
			html += '<tr>';
			html += '<td style="vertical-align:middle;">';
			html += '<a class="fbphotobox-a" title="Next" style="background-image: url(/lib/images/Arrows-RWhite-icon.png);background-repeat: no-repeat;background-size:auto;';
			...
			html += '<img src="/lib/images/close.png" style="height:10px;width:10px"/>';
			html += '</a>';
			...
			html += '<div class="fbphotobox-fc-header-left" style="float:left"></div>';
			html += '<a class="fbphotobox-fc-close-btn" href="" style="color: #FFFFFF;float: right;padding: 2px 10px;text-decoration: none;"><i class="fa fa-times fa-lg"></i></a>';
			html += '<div style="clear:both"></div>';
			html += '</div>';
			...
			html += '<a class="fbphotobox-a" title="Next" style="background-image: url(/lib/images/Arrows-RWhite-icon.png);background-repeat: no-repeat;';
